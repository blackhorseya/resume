...
{Jun. 2020 - Present} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    \item {Design and implement Elastic Stack as a logging system. After comparing filebeat and fluentd, because Filebeat is closer to the native Elastic Stack and the current number of services does not need to use fluentd.}
    ...
    \item {Use kubernetes, GCR, Spinnaker and Ansible on Jenkins to design and build CI/CD pipelines on containerized applications to achieve the goal of daily deployment. Among them, Trunk-based development is used as a software development strategy.}
  \end{cvitems}
}
