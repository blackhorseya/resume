...
{Jun. 2021 - Present} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    \item {Develop and maintain Schema Control Portal using Golang and Gin framework. The product provides the ability to scan column and sample data of various databases and right management for different users.}
    \item {Develop CI/CD pipeline via shell script and python on Jenkins to achieve deployment and high quality code.}
  \end{cvitems}
}
