...
{Aug. 2025 - Present} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    \item {Codified a multi-project GCP platform with Terraform and Terragrunt, covering GKE, Cloud SQL, Pub/Sub and least-privilege IAM, and standardized workload authentication on Workload Identity, eliminating out-of-band configuration drift.}
